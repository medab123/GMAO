...
(function (a) {
    ...
    a.extend(a.jqx._jqxFileUpload.prototype, {
            ...
            if (m === "localization") {
                ...
                if (!e.renderFiles) {
                    if (
                        ...
                        a("#" + b + " .jqx-file-upload-file-upload").attr(
                            "title",
                            k.uploadFileTooltip
                        );
                    }
                    if (
                        ...
                        a("#" + b + " .jqx-file-upload-file-cancel").attr(
                            "title",
                            k.cancelFileTooltip
                        );
                    }
            ...
            if (k !== c) {
                switch (m) {
                    ...
                    case "disabled":
                        ...
                        if (k === true) {
                            e.host.addClass(
                                e.toThemeProperty("jqx-fill-state-disabled")
                            );
                        } else {
                            e.host.removeClass(
                                e.toThemeProperty("jqx-fill-state-disabled")
        ...
        _addClasses: function () {
            ...
            b.host.addClass(
                b.toThemeProperty(
                    "jqx-widget jqx-widget-content jqx-rc-all jqx-file-upload"
                )
            );
            if (b.disabled === true) {
        ...
        _appendElements: function () {
            ...
            g._browseButton = a(
                '<button  type="button" id="' +
                    i +
                    'BrowseButton" class="' /*+
                    g.toThemeProperty("jqx-file-upload-button-browse")*/ + " "+g.btnClass+
                    '">' +
                    c +
                    "</button>"
            );
            ...
            g._bottomButtonsContainer = a(
                '<div class="' +
                    g.toThemeProperty("jqx-file-upload-buttons-container") +
                    '"></div>'
            );
            ...
            if (g.rtl) {
                g._browseButton.addClass(
                    g.toThemeProperty("jqx-file-upload-button-browse-rtl")
                );
                g._cancelButton.addClass(
                    g.toThemeProperty("jqx-file-upload-button-cancel-rtl")
                );
                g._uploadButton.addClass(
                    g.toThemeProperty("jqx-file-upload-button-upload-rtl")
                );
            ...
            g._uploadIframe = a(
                '<iframe name="' +
                    i +
                    'Iframe" class="' +
                    g.toThemeProperty("jqx-file-upload-iframe") +
                    '" src=""></iframe>'
            );
        ...
        _addFormAndFileInput: function () {
            ...
            var e = a(
                '<div class="' +
                    ...
                    '" target="' +
                    i +
                    'Iframe" method="post" enctype="multipart/form-data"></div>'
            );
            f.host.append(e);
            var d = a(
                '<input type="file" class="' +
                    f.toThemeProperty("jqx-file-upload-file-input") +
                    '" name="jqxFiles[]" />'
            );
            if (f.accept) {
           ...
           e.append(d);
            if (f._ieOldWebkit) {
                ...
                f.addHandler(e, "mouseenter.jqxFileUpload" + i, function () {
                    f._browseButton.addClass(
                        f.toThemeProperty("jqx-fill-state-hover")
                    );
                });
                f.addHandler(e, "mouseleave.jqxFileUpload" + i, function () {
                    f._browseButton.removeClass(
                        f.toThemeProperty("jqx-fill-state-hover")
                    );
                });
                f.addHandler(e, "mousedown.jqxFileUpload" + i, function () {
                    f._browseButton.addClass(
                        f.toThemeProperty("jqx-fill-state-pressed")
                    );
                });
                f.addHandler(
                    a(document),
                    ...
                    function () {
                        if (
                            f._browseButton.hasClass("jqx-fill-state-pressed")
                        ) {
                            f._browseButton.removeClass(
                                f.toThemeProperty("jqx-fill-state-pressed")
                            );
        ...
        _addFileRow: function (f, b, e, d) {
            ...
            l = a(
                '<div class="' +
                    h.toThemeProperty(
                        "jqx-widget-content jqx-rc-all jqx-file-upload-file-row"
                    ) +
                    '"></div>'
            );
            ...
            if (!h.renderFiles) {
                g = a(
                    '<div class="' +
                        h.toThemeProperty(
                            "jqx-widget-header jqx-rc-all jqx-file-upload-file-name"
                        ) +
                        '">' +
                        f +
                        "</div>"
                ...
                j = a(
                    '<div class="' +
                        h.toThemeProperty(
                            "jqx-widget-header jqx-rc-all jqx-file-upload-file-cancel"
                        ) +
                        '" title="' +
                        i +
                        '"><div class="' +
                        h.toThemeProperty(
                            "jqx-icon-close jqx-file-upload-icon"
                        ) +
                        '"></div></div>'
                );
                l.append(j);
                ...
                m = a(
                    '<div class="' +
                        h.toThemeProperty("jqx-file-upload-loading-element") +
                        '"></div>'
                );
                l.append(m);
                if (h.rtl) {
                    g.addClass(
                        h.toThemeProperty("jqx-file-upload-file-name-rtl")
                    );
                    j.addClass(
                        h.toThemeProperty("jqx-file-upload-file-cancel-rtl")
                    );
                    n.addClass(
                        h.toThemeProperty("jqx-file-upload-file-upload-rtl")
                    );
                    m.addClass(
                        h.toThemeProperty("jqx-file-upload-loading-element-rtl")
                    );
                }
                h._setMaxWidth({
                    fileNameContainer: g,
        ...
        _setMaxWidth: function (c) {
            var e = this;
            var f =
                c.cancelFile.outerWidth(true) + c.uploadFile.outerWidth(true);
            var b = e._ie7 ? 6 : 0;
            var d =
                e.host.width() -
                ...
                function () {
                    ...
                    if (b._iframeInitialized === false) {
                        ...
                        if (b._uploadQueue.length > 0) {
                            b._raiseEvent("3", {
                                file: b._uploadQueue[b._uploadQueue.length - 1]
                                    .fileName,
                                response: d,
                            });
                        }
                        ...
                        if (b._uploadQueue.length > 0) {
                            b._uploadFile(
                                b._uploadQueue[b._uploadQueue.length - 1]
                            );
                        }
                    }
                }
